...
public class HomePage extends AppTest{
	...
	public boolean verifyQaInfoTechWebPageLoaded() {
		 logoimg = 
				driver.findElement
				(By.cssSelector(".container_full .logo.onepage.logo_lg"));
	...
	public boolean checkavailink() {
		searchlink=driver.findElement(By.cssSelector("entry-content blog_postcontent"));
	...
	public boolean scrollverticalnav()
	{
		...
		String b=service.getAttribute("class");
		if(b.equals("active")) {
			return true;
		}
		else
