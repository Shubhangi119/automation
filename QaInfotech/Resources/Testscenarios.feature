...
Scenario: The user clicks on "VERTICALS" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website
...
Scenario: The user clicks on "SERVICES" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website
...
Scenario: The user clicks on "CONTACT" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website
...
Scenario: The user clicks on "KNOWLEDGE CENTER" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website
