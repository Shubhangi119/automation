...
Scenario: When the user clicks on "ABOUT" link appearing in the topbar , he/she moves to about section in the website.
Given the user is on homepage of the qainfotech website
...
Scenario: When the user clicks on "SERVICES" link appearing in the topbar , he/she moves to about section in the website.
Given the user is on homepage of the qainfotech website
...
Scenario: When the user clicks on "VERTICALS" link appearing in the topbar , he/she moves to about section in the website.
Given the user is on homepage of the qainfotech website
...
Scenario: When the user clicks on "CONTACT" link appearing in the topbar , he/she moves to about section in the website.
Given the user is on homepage of the qainfotech website
...
Scenario: When the user clicks on "NEWS" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website 
...
Scenario: When the user clicks on "TEAM" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website
...
Scenario: When the user clicks on "KNOWLEDGE CENTER" link appearing in the topbar , he/she moves to about section in the website
Given the user is on homepage of the qainfotech website
...
Scenario: When the user types any avaialable query in the search bar of the website , the websites gives responses.
